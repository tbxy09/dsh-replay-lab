	...
	factory: (require) => {
		...
		function EvidenceNarrativePanel({ experiment, summarizing, onSummarize }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
				...
				"aria-labelledby": "rld-evidence-narrative-heading",
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("header", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("h3", {
					id: "rld-evidence-narrative-heading",
					children: heading
				}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: "One direct model-runtime call · no agent" })] }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					className: "rld-disclosure-body",
					children: [
						narrative?.text === void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
							className: "rld-result-empty",
							children: narrative?.error ?? "Raw calls and deterministic facts are ready to summarize."
						}) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("blockquote", { children: narrative.text }),
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
							type: "button",
							disabled: summarizing || experiment.callEvidenceComparison === void 0,
							onClick: onSummarize,
							children: summarizing ? "Summarizing…" : narrative?.status === "completed" ? "Regenerate summary" : "Summarize raw evidence"
						})
					]
				})]
			});
		...
		function CompletedResult({ replayCase, experiment, activeExperiment, variants, history, routeLineage, workspaceDrift, summarizing, onPlan, onSummarize, onSelectHistory }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("main", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)(EvidenceNarrativePanel, {
						experiment,
						summarizing,
						onSummarize
					}),
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					completedResult ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(CompletedResult, {
						...
						onSummarize: () => {
							controller.summarize(displayedExperiment.id);
						},
...
.rld-evidence-narrative .rld-disclosure-body{padding:16px}.rld-evidence-narrative blockquote{margin:0 0 12px;color:#27364b;font-size:12px;line-height:1.65}.rld-evidence-narrative .rld-behavior-note{padding:10px 0;text-align:left}.rld-evidence-narrative button{min-height:32px;padding:0 12px;border:1px solid #1e55bd;border-radius:5px;background:#245fda;color:#fff;font-size:10px;font-weight:650;cursor:pointer}.rld-evidence-narrative button:disabled{border-color:#d0d5dd;background:#e4e7ec;color:#98a2b3;cursor:not-allowed}
@media(max-width:560px){.rld-route-lineage article{display:block}.rld-route-lineage dl{margin-top:10px}}
