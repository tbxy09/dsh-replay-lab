window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function EvidenceValidityStrip({ baseline, candidate, scorecard, workspaceDrift, baselineFallback }) {
			...
			const independent = scorecard !== void 0;
			...
			const workspaceTone = workspaceDrift === void 0 ? "unknown" : workspaceDrift.detected ? "warning" : "good";
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
				className: "rld-result-validity",
				"aria-label": "Evidence validity",
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						"data-tone": evidenceTone,
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							className: "rld-result-validity-icon",
							"aria-hidden": "true",
							children: independent ? "✓" : complete ? "!" : "?"
						}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("strong", { children: ["Independent evidence · ", independent ? "Complete" : complete ? "Not independent" : "Incomplete"] }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("small", { children: independent ? "Distinct durable sessions and evidence hashes." : "Numeric comparison is unavailable." })] })]
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						"data-tone": routeTone,
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							className: "rld-result-validity-icon",
							"aria-hidden": "true",
							children: comparison.routeStatus === "match" ? "↔" : comparison.routeStatus === "mismatch" ? "!" : "?"
						}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("strong", { children: ["Route · ", comparison.routeStatus === "match" ? "Match" : comparison.routeStatus === "mismatch" ? "Mismatch" : "Unknown"] }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("small", { children: "Compared from recorded provider / model request headers." })] })]
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							className: "rld-result-validity-icon",
							"aria-hidden": "true",
							children: workspaceDrift === void 0 ? "?" : workspaceDrift.detected ? "!" : "✓"
						}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("strong", { children: ["Workspace · ", workspaceDrift === void 0 ? "Unknown" : workspaceDrift.detected ? "Drift" : "No drift"] }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("small", { children: workspaceDrift?.detected === true ? "Candidate copied a changed source state." : workspaceDrift === void 0 ? "Legacy provenance has no drift witness." : "Frozen and copied source hashes match." })] })]
					})
				]
			});
		}
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("main", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("details", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("summary", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", { children: "Raw evidence" }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: "Session IDs, events, request headers, and captured token totals" })] }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("header", {
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("h2", { children: completedResult ? `Turn ${replayCase.sourceTurn} comparison` : `Current session · Turn ${replayCase.sourceTurn}` }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", { children: completedResult ? "This observed baseline is fixed. One isolated candidate was executed and recorded." : "This observed baseline is fixed. Choose one isolated candidate, then explicitly approve its run." })] }),
							...
							completedResult && displayedExperiment !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(EvidenceValidityStrip, {
...
.rld-result{padding:16px 18px 28px;background:#fff}.rld-result-validity{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));border:1px solid var(--rld-border);border-radius:5px;background:#fff}.rld-result-validity>div{display:grid;grid-template-columns:34px minmax(0,1fr);align-items:start;gap:10px;min-height:92px;padding:15px 16px;border-right:1px solid var(--rld-border)}.rld-result-validity>div:last-child{border-right:0}.rld-result-validity-icon{display:grid;width:30px;height:30px;place-items:center;border-radius:50%;background:#eef2f6;color:#475467;font-size:15px;font-weight:750}.rld-result-validity>div>span:last-child{display:flex;min-width:0;flex-direction:column;gap:4px}.rld-result-validity strong{font-size:13px;line-height:1.35}.rld-result-validity small{color:var(--rld-muted);font-size:11px;line-height:1.45}.rld-result-validity>div[data-tone=good] .rld-result-validity-icon{background:#dcfce7;color:#087443}.rld-result-validity>div[data-tone=good] strong{color:#14532d}.rld-result-validity>div[data-tone=warning] .rld-result-validity-icon{background:#fff4e5;color:#b54708}.rld-result-validity>div[data-tone=warning] strong{color:#93370d}
...
.rld-result-disclosure{margin-top:10px;border:1px solid var(--rld-border);border-radius:5px;background:#fff;overflow:hidden}.rld-result-disclosure>summary{position:relative;display:flex;align-items:center;justify-content:space-between;gap:16px;min-height:44px;padding:0 14px;cursor:pointer;list-style:none}.rld-result-disclosure>summary::-webkit-details-marker{display:none}.rld-result-disclosure>summary::after{content:'⌄';color:#667085;font-size:15px;transition:transform .15s ease}.rld-result-disclosure[open]>summary::after{transform:rotate(180deg)}.rld-result-disclosure>summary strong{font-size:12px}.rld-result-disclosure>summary span{margin-left:auto;color:var(--rld-muted);font-size:10px}.rld-result-disclosure[open]>summary{border-bottom:1px solid var(--rld-border);background:#fbfcfe}.rld-result-disclosure .rld-session-evidence-grid{border-bottom:0}.rld-result-disclosure .rld-session-evidence{padding:16px}.rld-result-setup-grid{display:grid;grid-template-columns:minmax(0,1fr) minmax(0,1.05fr)}.rld-result-setup-grid>.rld-session-frozen{border-right:1px solid var(--rld-border);border-bottom:0}.rld-result-setup-grid>.rld-session-variants{min-width:0;border-bottom:0;overflow:auto}.rld-result-setup-grid .rld-session-frozen dl{grid-template-columns:repeat(2,minmax(0,1fr));gap:10px}.rld-result-setup-grid .rld-session-variant-head,.rld-result-setup-grid .rld-session-variant{grid-template-columns:1.2fr 1fr 1fr 76px}.rld-result-history-list{display:flex;overflow:auto}.rld-result-history-list button{display:flex;min-width:250px;align-items:center;justify-content:space-between;gap:14px;padding:11px 14px;border:0;border-right:1px solid #e9edf3;background:#fff;color:var(--rld-text);text-align:left;cursor:pointer}.rld-result-history-list button:hover{background:#f8fafc}.rld-result-history-list button[aria-pressed=true]{background:#eef4ff;box-shadow:inset 0 -2px var(--rld-blue)}.rld-result-history-list button>span{display:flex;min-width:0;flex-direction:column;gap:2px}.rld-result-history-list button>span:last-child{align-items:flex-end}.rld-result-history-list button strong{font-size:11px}.rld-result-history-list button small{color:var(--rld-muted);font-size:9px}.rld-result-history-list button em{color:#667085;font-size:9px;font-style:normal;font-weight:700;text-transform:uppercase}.rld-result-history-list button em[data-status=completed]{color:#087443}.rld-result-history-list button em[data-drift]{color:#b54708;text-transform:none}.rld-result-saved-setup{margin:10px 14px}.rld-session-run>.rld-session-evidence{border-right:0;border-bottom:1px solid var(--rld-border)}
@media(max-width:820px){.rld-result{padding:12px}.rld-result-validity{display:block}.rld-result-validity>div{min-height:0;border-right:0;border-bottom:1px solid var(--rld-border)}.rld-result-validity>div:last-child{border-bottom:0}.rld-result-section>header{align-items:flex-start;flex-direction:column;gap:2px;padding-top:10px;padding-bottom:10px}.rld-result-section table{min-width:720px}.rld-result-disclosure>summary{align-items:flex-start;flex-wrap:wrap;gap:2px;padding-top:10px;padding-bottom:10px}.rld-result-disclosure>summary span{width:calc(100% - 24px);margin-left:0}.rld-result-disclosure>summary::after{position:absolute;right:26px}.rld-result-setup-grid{display:block}.rld-result-setup-grid>.rld-session-frozen{border-right:0;border-bottom:1px solid var(--rld-border)}.rld-result-setup-grid .rld-session-variant-head,.rld-result-setup-grid .rld-session-variant{min-width:600px}.rld-result-history-list{display:block}.rld-result-history-list button{width:100%;min-width:0;border-right:0;border-bottom:1px solid #e9edf3}.rld-session-evidence-grid{grid-template-columns:1fr}.rld-session-evidence{border-right:0;border-bottom:1px solid var(--rld-border)}.rld-session-evidence:last-child{border-bottom:0}}
.rld-session-workbench-header[data-result]{padding-bottom:0}.rld-session-workbench-header[data-result]>.rld-result-validity{grid-column:1/-1;margin:8px -18px 0;border-width:1px 0 0;border-radius:0;background:#fbfcfe}.rld-session-workbench-header[data-result]>.rld-result-validity>div{min-height:64px;padding:10px 14px;background:#fff}.rld-session-workbench-header[data-result] .rld-result-validity-icon{width:26px;height:26px;font-size:13px}.rld-result>.rld-result-section:first-child{margin-top:0}
@media(max-width:820px){.rld-session-workbench-header[data-result]{grid-template-columns:minmax(0,1fr) auto;gap:8px 10px;padding:10px 12px 0}.rld-session-workbench-header[data-result]>button{grid-column:1/-1;justify-self:start}.rld-session-workbench-header[data-result]>div{grid-column:1;min-width:0}.rld-session-workbench-header[data-result]>strong{grid-column:2;align-self:end;justify-self:end}.rld-session-workbench-header[data-result]>.rld-result-validity{grid-column:1/-1;display:flex;margin:4px -12px 0;overflow:hidden}.rld-session-workbench-header[data-result]>.rld-result-validity>div{grid-template-columns:24px minmax(0,1fr);flex:1 1 0;min-width:0;gap:7px;min-height:54px;padding:8px 10px;border-right:1px solid var(--rld-border);border-bottom:0}.rld-session-workbench-header[data-result]>.rld-result-validity>div:last-child{border-right:0}.rld-session-workbench-header[data-result] .rld-result-validity-icon{width:22px;height:22px;font-size:12px}.rld-session-workbench-header[data-result] .rld-result-validity strong{font-size:11px;line-height:1.3}.rld-session-workbench-header[data-result] .rld-result-validity small{display:none}}
