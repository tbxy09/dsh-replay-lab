	...
	factory: (require) => {
		...
		function ScorecardTable({ scorecard, missingReason, workspaceDrift }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("header", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("h3", { children: "Scorecard" }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: drift?.detected === true ? "Workspace drift recorded" : "Independent evidence only" })] }),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)(WorkspaceDriftNotice, { drift }),
					scorecard === void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
						className: "rld-session-muted",
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("td", {
							"data-change": metricDeltaChange(row.delta),
								...
								history.length > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
									...
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("header", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("h3", { children: "Saved runs" }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", { children: [history.length, " retained for this turn"] })] }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", { children: history.map((entry) => {
										...
										return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
											...
											children: [
												/* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", { children: variant?.label ?? entry.experiment.candidateVariantId }),
												/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", { children: [
													statusLabel[entry.experiment.status],
													" · ",
													new Date(entry.experiment.updatedAt).toLocaleString()
												] }),
												(entry.experiment.scorecard?.workspaceDrift?.detected === true || entry.experiment.candidate?.workspace?.drift?.detected === true) && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("em", { children: "Workspace drift" })
											]
										}, entry.experiment.id);
									}) })]
								}),
