window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function compareRequestSurfaces(baseline, candidate, baselineFallback) {
			...
			const baselineRoute = baselineSurfaces.length > 0 ? baselineSurfaces.map((surface) => `${surface.provider} / ${surface.model}`) : baselineFallback === void 0 ? [] : [`${baselineFallback.provider} / ${baselineFallback.model}`];
			...
			const baselineSystemHashes = baselineSurfaces.length > 0 ? baselineSurfaces.map((surface) => surface.systemHash) : baselineFallback === void 0 ? [] : [baselineFallback.systemHash];
			const candidateSystemHashes = candidateSurfaces.map((surface) => surface.systemHash);
			const baselineToolSchemaHashes = baselineSurfaces.length > 0 ? baselineSurfaces.map((surface) => surface.toolSchemaHash) : baselineFallback === void 0 ? [] : [baselineFallback.toolSchemaHash];
		...
		function CompletedResult({ replayCase, experiment, activeExperiment, variants, history, workspaceDrift, onPlan, onSelectHistory }) {
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("main", {
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)(EvidenceValidityStrip, {
