...
.rld-result-runs table{width:max-content;min-width:100%;font-size:11px}.rld-result-runs thead th:first-child{min-width:150px}.rld-result-runs thead th:not(:first-child){min-width:190px}.rld-result-runs thead th{vertical-align:bottom}.rld-result-runs thead th>strong,.rld-result-runs thead th>small{display:block}.rld-result-runs thead th>strong{color:#27364b;font-size:11px}.rld-result-runs thead th>small{margin-top:2px;color:var(--rld-muted);font-size:9px;font-weight:400}.rld-result-runs th[data-active],.rld-result-runs td[data-active]{background:#f5f8ff}.rld-result-runs td{min-width:190px}.rld-result-runs td>strong{display:block;margin-bottom:6px;color:#344054;font-size:11px;font-variant-numeric:tabular-nums}.rld-result-runs td[data-active]>strong{color:#1d4ed8}.rld-result-bar{display:block;height:7px;overflow:hidden;border-radius:2px;background:#edf0f5}.rld-result-bar>span{display:block;height:100%;border-radius:2px;background:#98a2b3}.rld-result-runs td[data-kind=candidate] .rld-result-bar>span{background:#6f91dc}.rld-result-runs td[data-active] .rld-result-bar>span{background:var(--rld-blue)}
