...
export function replayTurnKey(sessionId: string, turn: number): string {
  return `${sessionId}:${turn}`
}

export function replayTurnTestId(sessionId: string, turn: number): string {
...
export interface ApiSuccess<T> { ok: true; value: T }
